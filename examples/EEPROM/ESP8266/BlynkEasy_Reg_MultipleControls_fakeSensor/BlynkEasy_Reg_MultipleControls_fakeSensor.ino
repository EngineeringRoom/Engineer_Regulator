/*
    ...
    https://github.com/EngineeringRoom/Engineer_Regulator/tree/main/examples/EEPROM/ESP8266/BlynkEasy_Reg_MultipleControls_fakeSensor/img
    ...
    нужно раскоментировать строки(65-89) и установить "зоводские настройки" залить скетч. После опять закоментировать и еще раз залить скетч.
