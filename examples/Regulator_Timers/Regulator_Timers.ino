/*
    ...
    Этот пример демонстрирует как убрать вкладку Timers.h что бы она нам не мешала.
    Суть простая вкладку нужно поместить в папку data и изменить вот тут
    #include "data/Timers.h" 
...
#include "data/Timers.h"               // Подключаем вкладку с функцией таймера
