#ifndef Engineer_RegulatorEEPROM_h
#define Engineer_RegulatorEEPROM_h
...
////////////////////////////////////////////////
// Работа с RegulatorEEPROM

class RegulatorEEPROM : public Regulator {
  ...
  public:
    ...
    // Статические переменные, одни и те же для всех экземпляров класса
  uint16_t  RegulatorEEPROM::EEPROMaddr=0;          // адрес EEPROM
  uint16_t  RegulatorEEPROM::EEPROMcheck=12456;     // служит для проверки записанно у нас что то в EEPROM или нет  
